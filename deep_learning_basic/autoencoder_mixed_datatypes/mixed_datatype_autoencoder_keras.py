...
#
# Usage:
#   python3 mixed_datatype_autoencoder_keras.py drug_data_coded_tobesaved_curated_noheader.tsv  drug_data_autoencoder 0.01
#   py      mixed_datatype_autoencoder_keras.py drug_data_coded_tobesaved_curated_noheader.tsv  drug_data_autoencoder 0.01
#
# Adapted from:
...
if __name__ == '__main__':
    ...
    str_loss_function = 'binary_crossentropy' # 'kullback_leibler_divergence'

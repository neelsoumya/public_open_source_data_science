...
# TODO: CONVERT WORDS TO CATEGORICAL
visible1 = Input(shape=(25000,80))
hidden1  = Dense( output_dim=i_num_neurons_layer_1)(visible1)
# hidden1  = Embedding(input_dim=max_features, output_dim=i_num_neurons_layer_1)(visible1)
hidden2  = LSTM(units=i_num_neurons_layer_1, activation=str_activation_layer1, dropout=f_dropout, recurrent_dropout=f_dropout, kernel_initializer=k_kernel_initializer)(hidden1)

# TODO: CONVERT WORDS TO CATEGORICAL
visible1_2 = Input(shape=(25000,82)) # 2 more features
hidden1_2  = Dense( output_dim=i_num_neurons_layer_1)(visible1_2)
# hidden1  = Embedding(input_dim=max_features, output_dim=i_num_neurons_layer_1)(visible1)
hidden2_2  = LSTM(units=i_num_neurons_layer_1, activation=str_activation_layer1, dropout=f_dropout, recurrent_dropout=f_dropout, kernel_initializer=k_kernel_initializer)(hidden1_2)


merge = concatenate([hidden2, hidden2_2])

hidden_final = Dense(output_dim=i_num_neurons_layer_2)(merge)


model = Model(inputs=[visible1, visible1_2], outputs=hidden_final)
...
keras.utils.plot_model(model, to_file='graph_lstm_imdb_model_merge.png', show_shapes=True,

...
model.add(Dense(units=i_num_neurons_layer_1, activation=str_activation_layer2, input_dim=10,
...
temp_str_peptide_file = "breast-cancer-wisconsin_MOD_CURATED_categorical_test.data"
...
x_train_array_categorical = keras.utils.to_categorical(x_train_categorical, 2)
...
x_test_array_categorical = keras.utils.to_categorical(x_test_categorical, 2)

...
model.add(Dense(units=i_num_neurons_layer_1, activation=str_activation_layer2, input_dim=12,
...
temp_str_peptide_file = "breast-cancer-wisconsin_MOD_CURATED_categorical_test2.data"

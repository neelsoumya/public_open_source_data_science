...
b = TreeBagger(iNumBags,X,Y,'Method',str_method,'OOBVarImp','On',...
    'MinLeafSize',min_leaf_size)%,'OOBPredictorImportance','on');
...
% TODO: get predictor importance
% also CART does different on categorical predictors
% TODO: see http://uk.mathworks.com/help/stats/treebagger.html Section Unbiased Predictor Importance Results
